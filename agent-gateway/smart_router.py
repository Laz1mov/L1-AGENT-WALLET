...
def build_default_providers() -> list[Provider]:
    ...
    return [
        ...
        Provider(
            ...
            big_model=big if "gemini" in big else "gemini-2.0-pro",
        ...
        Provider(
            ...
            big_model=big if "claude" in big else "claude-3-5-sonnet-latest",
            small_model=small if "claude" in small else "claude-3-5-haiku-latest",
        ),
        Provider(
            name="ollama",
